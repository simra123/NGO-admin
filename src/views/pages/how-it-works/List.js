                ...
                <CTabPane data-tab="forms" id="forms">
                    <CRow>
                                ...
                                <CCardBody>
                                    ...
                                    <CCol xs="12">
                                        <CFormGroup>
                                            ...
                                            <CInput id="main-heading" placeholder="How it Works" required />
                                        </CFormGroup>
                                    </CCol>
                                        <CCol xs="12">
                                            <CFormGroup >
                        ...
                        <CCol xs="12" sm="6">
                            <TextEditor
                            heading="Icon text"
                            value="<h1> Join the Network</h1> <br/> <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores, necessitatibus! </p>"
                            />
                        </CCol>
                        <CCol xs="12" sm="6">
                            <TextEditor
